...
export default function Banner() {
    ...
    return isOpen && (
        <div className="w-full px-6 py-1 font-medium text-sm text-white text-center bg-gradient-to-r from-blue-400 via-[#3b6fe8] to-[#e07e4a]">
            <div className='flex items-center justify-between max-w-7xl  mx-auto'>
                <p>Get upto 20% OFF on Your First Order!</p>
