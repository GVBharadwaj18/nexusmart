...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+911234567890", path: '/', icon: MailIcon },
                { text: "nexusmart@gmail.com", path: '/', icon: PhoneIcon },
                { text: "183 Navi Mumbai, 94102", path: '/', icon: MapPinIcon }
            ]
        }
    ];
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-blue-600">Nexus</span>Mart<span className="text-blue-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Step into NexusMart, where the latest technology meets smart living. Explore cutting-edge smartphones, stylish smartwatches, and all the accessories you need, all under one roof.</p>
